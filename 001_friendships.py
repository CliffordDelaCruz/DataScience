...
interests = [
    ...
    (1, "NoSQL"), (1, "MongoDB"), (1, "Cassandra"), (0, "HBase"),
...
#building an index from interests to users (this is useful when there is a lot of users and interests to sift through)
...
# Populate salary by year dictionary from list above.
...
# Paid Accounts
# try to predict "paid" for users with very few and very many years of experience, 
